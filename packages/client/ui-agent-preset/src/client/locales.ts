...
export const pt: Record<AgentPresetSettingsKey, string> = {
  ...
  description: 'Vale para as sessões que você iniciar a partir de agora. Sessões em execução mantêm o preset com que começaram.',
  loading: 'Carregando presets…',
  error: 'Não foi possível carregar os presets do agente.',
  userTrust: 'Personalizado',
  seatHint: 'Preset do agente para a sessão que você está prestes a iniciar',
  headerHint: 'O preset do agente que esta sessão executa, fixado quando ela começou',
  nav: 'Presets do agente',
  sectionIntro: 'Um preset é a composição de plugins que o agente de uma sessão executa — suas ferramentas, prompt e capacidades. Duplique um existente e torne-o seu, ou deixe o agente rascunhar um para você no modo Criador.',
  builtIn: 'Integrado',
  setDefault: 'Definir como padrão',
  view: 'Ver',
  presetStandardName: 'Modo padrão',
  presetStandardDescription: 'Agente de codificação completo, com edição de arquivos, shell, busca em arquivos e na web, skills, planos, metas, subagentes e fluxos de trabalho.',
  presetCodeName: 'Modo PTC',
  presetCodeDescription: 'Todas as capacidades do modo padrão, com ferramentas expostas pelo SDK do Code Mode para que o modelo combine operações de vários passos em um programa TypeScript.',
  ...
  presetCordisDescription: 'Feito para criar presets personalizados de agente: todas as capacidades do modo padrão, mais inspeção do runtime, experimentos de plugins e orientação de criação de presets.',
  duplicate: 'Duplicar',
  ...
  copyIntro: 'O preset inteiro é copiado nesta máquina. O identificador se torna o nome do diretório e não pode ser alterado depois; todo o resto é editado nos próprios arquivos do preset.',
  create: 'Criar',
  creating: 'Criando…',
  creatorDraft: 'Rascunhar um preset personalizado com o modo Criador',
  ...
  deleteDescription: 'O diretório do preset será excluído. Sessões já em execução nele continuam funcionando; novas sessões não poderão selecioná-lo.',

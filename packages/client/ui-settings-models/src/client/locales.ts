...
/** pt-BR strings (same keys as {@link en}). */
export const pt: { [Key in keyof typeof en]: string } = {
  nav: 'Modelos',
  title: 'Modelos',
  intro: 'Informe as chaves de API para usar modelos dos provedores a seguir.',
  edit: 'Editar',
  editProvider: 'Editar {provider}',
  remove: 'Excluir',
  removeProvider: 'Excluir {provider}',
  deleteTitle: 'Excluir {provider}?',
  deleteDescription: 'Excluir {provider} remove a configuração dele. Qualquer credencial que ele usa é gerenciada em outro lugar e será mantida.',
  ...
  keyPlaceholderNative: 'Digite uma chave de API, ou deixe em branco para usar autenticação do ambiente',
  ...
  modelsEmpty: 'Nenhum modelo será exibido no seletor. IDs fora da lista ainda podem ser enviados diretamente.',
  ...
  modelContextInvalid: 'A janela de contexto deve ser uma contagem positiva, como 131072, 256K ou 1M.',
  modelMaxTokensInvalid: 'O máximo de tokens de saída deve ser uma contagem positiva, como 8192, 64K ou 1M.',
  ...
  fetchNeedsBaseUrl: 'Informe a URL base antes de buscar.',
  fetchEmpty: 'O provedor não listou nenhum modelo. Adicione-os manualmente.',
  fetchTitle: 'Escolha os modelos a adicionar',
  fetchDescription: 'Estes são os modelos disponíveis neste provedor. Escolha quais adicionar.',
  ...
  customRouteInvalid: 'Comece com uma letra minúscula; depois use letras minúsculas, dígitos e hífens.',

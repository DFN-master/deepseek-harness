...
export const pt = {
  ...
  'hint.goal': 'descreva a meta para uma tarefa de longa duração',
  'hint.goal.active': 'meta em andamento — edit / pause / resume / clear',
  ...
  'placeholder.parentOffline': 'A sessão pai está offline; não é possível enviar, mas você ainda pode parar a execução',
  ...
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter envia com prioridade todas as mensagens na fila',
  ...
  'settings.enter.description': 'Vale apenas quando o agente está executando; Cmd/Ctrl+Enter usa o outro comportamento',
  'settings.enter.queue': 'Enfileirar',
  'settings.enter.steer': 'Envio prioritário',
  'access.confirm.title': 'Ativar Full access?',
  'access.confirm.description': 'O Full access reduz etapas de confirmação e permite que o agente execute mais ações diretamente, incluindo operações sensíveis, alterações de arquivos ou comandos externos. Use-o apenas quando confiar na tarefa atual.',
  ...
  'todo.title': 'Tarefas',
  'todo.progress.done': '{done} concluída(s)',
  'todo.progress.active': '{active} em andamento',
  'todo.progress.pending': '{pending} pendente(s)',
  ...
  'message.contextRecall': 'Recall de sessão',
  'message.referenceSummary': 'Sessão referenciada · {labels}',
  'message.referenceSeparator': ', ',
  'message.context.instructions.loaded': 'carregada',
  'message.context.instructions.added': 'adicionada',
  'message.context.instructions.updated': 'atualizada',
  'message.context.instructions.removed': 'removida',
  ...
  'message.retry.status': '{label} ({retry}/{maximum}) · {seconds}s',
  'message.retry.delay': 'Espera da repetição: ',
  ...
  'message.maxTokens.hint': 'A resposta foi cortada; o que já foi gerado permanece na conversa. Envie "continue" para o modelo retomar.',
  ...
  'command.imagesUnsupported': '/{command} não aceita anexos de imagem; remova-as primeiro',
  ...
  'queue.steer': 'Enviar com prioridade',
  'queue.steer.unavailable': 'O envio prioritário está disponível apenas enquanto o agente está executando',
  ...
  'queue.steerFailed': 'Falha no envio prioritário. Tente novamente.',
